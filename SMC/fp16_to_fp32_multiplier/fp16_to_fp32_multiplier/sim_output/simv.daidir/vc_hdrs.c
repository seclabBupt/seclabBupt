...
#ifndef __VCS_IMPORT_DPI_STUB_fp16_inputs_mul_to_fp32_softfloat
#define __VCS_IMPORT_DPI_STUB_fp16_inputs_mul_to_fp32_softfloat
__attribute__((weak)) unsigned int fp16_inputs_mul_to_fp32_softfloat(/* INPUT */unsigned short int A_1, /* INPUT */unsigned short int A_2)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static unsigned int (*_vcs_dpi_fp_)(/* INPUT */unsigned short int A_1, /* INPUT */unsigned short int A_2) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (unsigned int (*)(unsigned short int A_1, unsigned short int A_2)) dlsym(RTLD_NEXT, "fp16_inputs_mul_to_fp32_softfloat");
    ...
    if (_vcs_dpi_fp_) {
        ...
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "fp16_inputs_mul_to_fp32_softfloat");
        return 0;
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_fp16_inputs_mul_to_fp32_softfloat */
